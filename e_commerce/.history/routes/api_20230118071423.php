...
Route::apiResource('/product', ProductController::class)->middleware('auth:api','admin')->except(['index','show','search']);
Route::get('search/{name}',[ProductController::class,'search']);
Route::apiResource('/category', CategoryController::class);
Route::apiResource('/user', UserController::class);
Route::post('/emailverify',[UserController::class,'verifyEmail'])->middleware('auth:api');
...
Route::post('/logoutuser',[LoginController::class,'logout'])->middleware('auth:api');
