...
Route::post('updategrade/{id?}',[GradeController::class,'update']);

//course routes

Route::post('addcourse',[GradeController::class,'store']);
Route::get('/allcourse',[GradeController::class,'index']);
Route::get('deletecourse/{id?}',[GradeController::class,'destroy']);
Route::post('updatecourse/{id?}',[GradeController::class,'update']);
